# Импортируй библиотеку tkinter и сохрани ее как tk
# Импортируй messagebox из tkinter

# Функция для проверки условий
def check_registration():
    try:
        # Получи данные от пользователя и сохрани в переменные age, passport и visa

        # Для каждой переменной пропиши условие, когда пользователь НЕ проходит регистрацию
